...
with open(r'Homework\hw_test_lesson_5\rle_text.txt','r', encoding='utf-8') as my_file:
...
with open(r'Homework\hw_test_lesson_5\rle_text.json','w', encoding='utf-8') as my_zip_file:
        my_zip_file.write(json.dumps(rle_zip(my_text), ensure_ascii=False))

with open(r'Homework\hw_test_lesson_5\rle_text.json','r', encoding='utf-8') as my_zip_file:
...
with open(r'Homework\hw_test_lesson_5\rle_text.txt','a', encoding='utf-8') as my_file:
        my_file.write(f'\n{rle_un_zip(spisok)}')
