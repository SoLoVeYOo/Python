def name_user():
    return input('Введите имя пользователя (для выхода в предыдущее меню введите "q" без ковычек): ')
...
def find_info():
    poisk = [i for i in input('Введите параметр поиска:'
    '\nесли "фамилия" введите 1, "имя" - 2, "телефон" - 3, "класс" - 4, "пол" - 5'
    '\nи через запятую введите критерий поиска'
    '\n(для выхода в предыдущее меню введите "q" без ковычек).'
    '\nВвод: ').split(',')]
    return poisk
